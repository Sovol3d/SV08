    ...
    def confirm_print_response(self, dialog, response_id, filename):
        ...
        if response_id == Gtk.ResponseType.OK:
            if self.switch_widget.get_active():
                isTimelapse = 1    
                self._screen._ws.klippy.gcode_script(f"SET_GCODE_VARIABLE MACRO=TIMELAPSE_TAKE_FRAME VARIABLE=enable VALUE={isTimelapse}")
